...
var KZ = {
"m.title":"Қарағандыдағы қорғаныш жабындар: өрттен қорғау, коррозиядан қорғау, гидрооқшаулау - TradeChem",
"m.desc":"«Tradechem» ЖШС, Қарағанды: қоймада 26 қорғаныш жабын позициясы. Protherma өрттен қорғау бояулары, ГОСТ бойынша коррозияға қарсы грунттар мен эмальдар, гидрооқшаулау, POLY TOP эпоксидті едендер, еріткіштер. Қазақстан мен Ресей зауыттарынан тікелей, бүкіл ел бойынша жеткізу.",
"m.ogt":"Қарағандыдағы қорғаныш жабындар - TradeChem",
"m.ogd":"Қоймада 26 позиция: Protherma өрттен қорғау, ГОСТ бойынша коррозияға қарсы грунттар мен эмальдар, гидрооқшаулау, POLY TOP эпоксидті едендер, еріткіштер. Зауыттардан тікелей, Қазақстан бойынша жеткізу.",
"a.home":"TradeChem, басты бетке","a.nav":"Сайт бөлімдері","a.lang":"Сайт тілі","a.call":"Қоңырау шалу","a.menu":"Мәзір",
"nav.og":"Өрттен қорғау","nav.gi":"Гидрооқшаулау","nav.po":"Едендер","nav.po2":"Полимерлі едендер","nav.ak":"Коррозиядан қорғау",
"nav.ra":"Еріткіштер","nav.kat":"Каталог","nav.ds":"Жеткізу","nav.kt":"Байланыс",
"b.wa":"WhatsApp арқылы бағасын білу","b.wa2":"WhatsApp-қа жазу","b.cat":"Каталог, 26 позиция","b.price":"Бағасын білу",
"b.ds":"Жеткізуді есептеу","b.call":"Қоңырау шалу","b.more":"Барлық 26 позицияны көрсету",

"h.kick":"Қарағанды · дистрибьюция · 2023 жылдан","h.h1a":"Қорғаныш","h.h1b":"жабындар",
"h.sub":"Өрттен қорғау · коррозиядан қорғау · гидрооқшаулау · полимерлі едендер",
"h.lead":"Қоймада 26 позиция, ыдысы 1 кг-нан 30 кг-ға дейін. ГОСТ және СТ-KZ, Қазақстан мен Ресей зауыттарынан тікелей жеткізілім, бүкіл Қазақстан бойынша жеткізу.",
...
"gi.a":"Бассейн жиегіндегі Rubber Master резеңке бояуы",
...
"ak.l":"Тот үстінен жағылатын 3-і 1-де грунт-эмальдан ГОСТ бойынша химияға төзімді ХВ және ХС-ке дейін. Ыдысы 18-30 кг, Қарағандыдағы қоймадан.",
...
"kat.k":"Каталог","kat.h":"Қоймада 26 позиция",
...
"c.rubber-master":"резеңке бояу","c.aqua-fix":"гидрооқшаулағыш мастика",
...
"tr.a":"Лак-бояу материалдарының қоймасы","tr.cap":"Қойма · Қарағанды",

"ds.k":"Жеткізу","ds.h":"Бүкіл Қазақстан бойынша жеткізу",
"ds.l":"Құны тапсырыс көлеміне байланысты. Қарағанды бойынша тапсырыс кезінде нақтыланады.",
...
"st.3":"Тиеп жөнелту","st.3p":"Тапсырысты Қарағандыдағы қоймада жинаймыз, құжаттарын береміз.",
...
"kt.city":"Қарағанды, Қазақстан","kt.geo":"Қарағандыдағы қоймадан тиеп жөнелту, бүкіл Қазақстан бойынша жеткізу",
...
"f.sub":"Қорғаныш жабындар · Қарағанды · 2023 жылдан",
"f.copy":"© 2026 «Tradechem» ЖШС. Өрттен қорғау, коррозиядан қорғау, гидрооқшаулау, полимерлі едендер."
};
